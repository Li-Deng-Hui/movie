		...
		<el-row class="header">
			<div class="head-bar" v-if="adminInfo.name">
				<div class="left">
					...
					<span slot="title" style="font-size: 16px;font-weight: bolder">懂你电影</span>
				</div>
				<div class="right">
					<img :src="adminInfo.avatar" class="user-avatar" width="40px" height="40px"
					...
					<el-dropdown style="margin-left:12px">
						...
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item @click="pseronalCenter">个人信息</el-dropdown-item>
...
<script>
	export default {
		...
		methods: {
			loadAdminInfo() {
				if (this.$store.getters.getUser == "userInfo") {
			...
			handleMenuItemClick(path) {
				this.$router.push('/admin/home' + path);
				this.currentMenuIndex = path;
			},
			pseronalCenter(){
				this.$router.push("/admin/home/pseronalCenter");
			}
		}
	};
</script>
